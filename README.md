...
Digital Persona Plugin 是一个面向 AI 工具的数字人格基础设施。它连接 Codex、Claude Code、OpenCode 等 agentic AI 工作流，将用户与 AI 的每一次协作沉淀为可管理、可召回、可演化的人格记忆。
...
随着记忆不断积累，系统会逐渐生成可管理的数字人格。这个人格不是一个固定人设，而是一个持续演化的精神结构。
